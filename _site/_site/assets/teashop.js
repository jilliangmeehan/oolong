  ...
  function Teashop($$anchor, $$props) {
    ...
    function saveGameState() {
      const gameState = {
        ...
        teapotStates: get(teapotRefs).map((teapot) => teapot ? teapot.getStat() : null)
      };
    ...
    template_effect(() => {
      ...
      set_text(text_4, `Harvest Sprites: ${get(sprites).harvest ?? ""}`);
