...
I have some ideas for what I might end up working on, but today I'm starting easy by getting this page up. Which, [thanks to an Obsidian plugin](https://jillian.garden/blog/using-obsidian-as-a-cms/), requires no code at all.