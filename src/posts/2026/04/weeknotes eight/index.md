---
title: weeknotes eight
layout: layouts/page.html
tags:
  - post
date: 2026-04-11
publish: true
summary: Trees are blooming! The sun is out! It feels like a miracle.
---
...
{% grid %}
![pear_blossoms.jpeg](./photos/pear_blossoms.jpeg)
![cj.jpeg](./photos/cj.jpeg)
{% endgrid %}

Also went to the RevenueCat event in New York to hear [mb's](https://mbbischoff.com) talk, and remembered that it is fun being around people and hearing about what they're working on or excited about. Networking is not my strong suit (I'm shy!), but I do like to tag along with [Lickability](https://lickability.com) folks and meet new people. I never know what to do when someone asks for my LinkedIn QR code, though — I guess I should download the app. 

{% grid %}
![selfie.jpeg](./photos/selfie.jpeg)
![hobonichi.jpeg](./photos/hobonichi.jpeg)
{% endgrid %}
