...
- Level one tank, ranged DPS, melee DPS, and healer to 50+
	...
	- **Melee DPS:** Dragoon (36)
	- **Healer:** Astrologian (34)
- Try to level DoH/DoL jobs evenly — I just started with this, but there are a few jobs I still need to get started with
- Get my Grand Company rank to Flame Sergeant Second Class so I can finally sell all the unused gear sitting in my inventory
	- Mostly running around doing FATEs for this
	- I know I should start doing supply and provisioning missions more while I level my crafters & gatherers